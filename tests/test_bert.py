...
import sys
sys.path.append('vqa/external/bert')
...
# Required parameters
parser.add_argument(
    "--input_file", default="tests/examples/input.txt", type=str)
parser.add_argument(
    "--output_file", default="tests/examples/output.txt", type=str)
...
parser.add_argument("--layers", default="-1,-2", type=str)
