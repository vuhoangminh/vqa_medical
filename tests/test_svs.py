...
dir_img = 'C:/Users/minhm/Documents/GitHub/vqa_idrid/data/raw/breast-cancer/ICIAR2018_BACH_Challenge/WSI'
...
for f in os.listdir(dir_img):
    ...
    for r in range(0,orig_w,patch_size[0]):
        print(">> processing {}/{}".format(r, len(range(0,orig_w,patch_size[0]))))
